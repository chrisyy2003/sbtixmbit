...
const SBTI_TYPES = [
  { value: "CTRL", label: "拿捏者" },
  { value: "ATM-er", label: "送钱者" },
  { value: "Dior-s", label: "屌丝" },
  { value: "BOSS", label: "领导者" },
  { value: "THAN-K", label: "感恩者" },
  { value: "OH-NO", label: "哦不人" },
  { value: "GOGO", label: "行者" },
  { value: "SEXY", label: "尤物" },
  { value: "LOVE-R", label: "多情者" },
  { value: "MUM", label: "妈妈" },
  { value: "FAKE", label: "伪人" },
  { value: "OJBK", label: "无所谓人" },
  { value: "MALO", label: "吗喽" },
  { value: "JOKE-R", label: "小丑" },
  { value: "WOC!", label: "握草人" },
  { value: "THIN-K", label: "思考者" },
  { value: "SHIT", label: "愤世者" },
  { value: "ZZZZ", label: "装死者" },
  { value: "POOR", label: "贫困者" },
  { value: "MONK", label: "僧人" },
  { value: "IMSB", label: "傻者" },
  { value: "SOLO", label: "孤儿" },
  { value: "FUCK", label: "草者" },
